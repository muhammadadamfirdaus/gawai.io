...
import {getPostsByTag, getPostsByBrand} from '../../actions/post-action';
            ...
            <div className="wrapper">
              <aside className="right">
                <section class="news">
                  <h2 class="subheading">
                    Populer Post 
                    <span id="name-tags" data-tags="Apple">
                      {/* tentang Laptop Gaming */}
                    </span>
                  </h2>
                  <div class="wrapper">
...
function mapDispatchToProps(dispatch, props){
  return bindActionCreators({
    getPostsByBrand: dispatch(getPostsByBrand(props.match.params.slug)),
